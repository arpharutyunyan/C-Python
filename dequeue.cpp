    ...
    public:
        ...
        void push_back(int n){
            if(isFull()){
                ...
                front = end = 0;
            }else if (end == 4){ // if index = 4 the after index = 5: for avoiding <index out bound of range> index = 0
                end == 0;
            }else{
                end++;
            }
        ...
        int pop_front(){
            if(isEmpty()){
                ...
                front = 0;            // if index = 4 the front index = 5: for avoiding <index out bound of range> index = 0
        ...
        int pop_back(){
            if(isEmpty()){
                ...
                end = 4;            // if index = 0 the front index = -1: for avoiding <index out bound of range> index = 4

...
class LinkedList{
    ...
    public:
        ...
        void insert_sort(){
            ...
            for(Node<T>* temp = head->next; temp!=nullptr; temp=temp->next){
                ...
                if(pre==nullptr){   // the first element
                    ...
                    Node<T>* t = temp;       // save the node temp, because in the loop I will lost the temp place
        ...
        void print(){
            ...
            for(Node<T>* h = head; h != nullptr; h = h -> next){
                cout << "value = " << h -> value << "\t";
        ...
        void print_reverse(){
            ...
            for(Node<T>* t = tail; t != nullptr; t = t -> previous){
                cout << "value = " << t -> value << "\t";
            }   
